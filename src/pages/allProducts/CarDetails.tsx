// import carImage from "@/assets/cardetails.jpg";
...
const CarDetails = () => {
  ...
  return (
    <Container>
      <div className="min-h-screen  text-my-text_clr">
        <div className="mx-auto">
          <div className="overflow-hidden">
            <div className="relative lg:h-[60vh]">
              ...
              <div className="absolute bottom-8 left-8 lg:bottom-16 lg:left-16 text-white">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              {car?.images?.slice(1).map((image: string, index: number) => (
                <div
                  key={index}
                  className="relative h-64 lg:h-[60vh] rounded overflow-hidden "
                >
                  <img
                    src={image}
